...
You may find it at https://gitlab.cern.ch/WisconsinCMS/CTP7-SW/UCT2016Layer1-user_apps
...
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/CTP7-SW/UCT2016Layer1-user_apps.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/CTP7-SW/UCT2016Layer1-user_apps.git
```
